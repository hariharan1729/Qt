...
#include <memory>
#include "../../../WeatherApp/src/Response.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Response_t qt_meta_stringdata_Response = {
    {
        ...
        QT_MOC_LITERAL(9, 15),  // "newDataRecieved"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 25),  // "std::shared_ptr<IMessage>"
        QT_MOC_LITERAL(52, 8)   // "pMessage"
    },
    "Response",
    "newDataRecieved",
    "",
...
Q_CONSTINIT const QMetaObject Response::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Response_t,
        ...
        // method 'newDataRecieved'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::shared_ptr<IMessage>, std::false_type>
    >,
    nullptr
} };
...
void Response::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newDataRecieved((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<IMessage>>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Response::*)(std::shared_ptr<IMessage> );
            if (_t _q_method = &Response::newDataRecieved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Response::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IResponse"))
        return static_cast< IResponse*>(this);
...
// SIGNAL 0
void Response::newDataRecieved(std::shared_ptr<IMessage> _t1)
{
