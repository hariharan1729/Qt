...
#include <memory>
#include "../../../WeatherApp/src/Renderer.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Renderer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Renderer_t qt_meta_stringdata_Renderer = {
    {
        QT_MOC_LITERAL(0, 8),  // "Renderer"
        QT_MOC_LITERAL(9, 17),  // "OnnewDataRecieved"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 25),  // "std::shared_ptr<IMessage>"
        QT_MOC_LITERAL(54, 13)   // "pReplyMessage"
    },
    "Renderer",
    "OnnewDataRecieved",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_Renderer[] = {
...
Q_CONSTINIT const QMetaObject Renderer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Renderer.offsetsAndSizes,
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->OnnewDataRecieved((*reinterpret_cast< std::add_pointer_t<std::shared_ptr<IMessage>>>(_a[1]))); break;
        default: ;
        }
    }
}
